...
import { PARSER_IBEACON, PARSER_ESTIMOTE, PARSER_ALTBEACON, PARSER_EDDYSTONE_TLM, PARSER_EDDYSTONE_UID, PARSER_EDDYSTONE_URL, transmissionSupport, } from './types';
// #region instanciation and constants
const BeaconsManager = NativeModules.BeaconsAndroidModule;
...
function detectIBeacons() {
    return new Promise((resolve, reject) => BeaconsManager.addParser(PARSER_IBEACON, resolve, reject));
}
/**
...
function removeIBeaconsDetection() {
    return new Promise((resolve, reject) => BeaconsManager.removeParser(PARSER_IBEACON, resolve, reject));
}
// #enregion
// #region altBeacon
/**
...
function detectAltBeacons() {
    return new Promise((resolve, reject) => BeaconsManager.addParser(PARSER_ALTBEACON, resolve, reject));
}
function addAltBeaconsDetection() {
    return new Promise((resolve, reject) => BeaconsManager.addParser(PARSER_ALTBEACON, resolve, reject));
}
function removeAltBeaconsDetection() {
    return new Promise((resolve, reject) => BeaconsManager.removeParser(PARSER_ALTBEACON, resolve, reject));
}
// #endregion
// #region estimote
/**
...
function detectEstimotes() {
    return new Promise((resolve, reject) => BeaconsManager.addParser(PARSER_ESTIMOTE, resolve, reject));
}
function addEstimotesDetection() {
    return new Promise((resolve, reject) => BeaconsManager.addParser(PARSER_ESTIMOTE, resolve, reject));
}
function removeEstimotesDetection() {
    return new Promise((resolve, reject) => BeaconsManager.removeParser(PARSER_ESTIMOTE, resolve, reject));
}
// #endregion
...
function detectEddystoneUID() {
    return new Promise((resolve, reject) => BeaconsManager.addParser(PARSER_EDDYSTONE_UID, resolve, reject));
}
/**
...
function removeEddystoneUIDDetection() {
    return new Promise((resolve, reject) => BeaconsManager.removeParser(PARSER_EDDYSTONE_UID, resolve, reject));
}
// #endregion
...
function detectEddystoneURL() {
    return new Promise((resolve, reject) => BeaconsManager.addParser(PARSER_EDDYSTONE_URL, resolve, reject));
}
function addEddystoneURLDetection() {
    return new Promise((resolve, reject) => BeaconsManager.addParser(PARSER_EDDYSTONE_URL, resolve, reject));
}
function removeEddystoneURLDetection() {
    return new Promise((resolve, reject) => BeaconsManager.removeParser(PARSER_EDDYSTONE_URL, resolve, reject));
}
// #endregion
...
function detectEddystoneTLM() {
    return new Promise((resolve, reject) => BeaconsManager.addParser(PARSER_EDDYSTONE_TLM, resolve, reject));
}
function addEddystoneTLMDetection() {
    return new Promise((resolve, reject) => BeaconsManager.addParser(PARSER_EDDYSTONE_TLM, resolve, reject));
}
function removeEddystoneTLMDetection() {
    return new Promise((resolve, reject) => BeaconsManager.removeParser(PARSER_EDDYSTONE_TLM, resolve, reject));
}
// #endregion
...
function detectCustomBeaconLayout(parser) {
    return new Promise((resolve, reject) => BeaconsManager.addParser(parser, resolve, reject));
}
...
function removeCustomBeaconLayoutDetection(parser) {
    return new Promise((resolve, reject) => BeaconsManager.removeParser(parser, resolve, reject));
}
// #endregion
// #region add remove multiple parsers in a row
function addParsersListToDetection(parsers) {
    return new Promise((resolve, reject) => BeaconsManager.addParsersListToDetection(parsers, resolve, reject));
}
function removeParsersListToDetection(parsers) {
    return new Promise((resolve, reject) => BeaconsManager.removeParsersListToDetection(parsers, resolve, reject));
}
// #endregion
...
function getRangedRegions() {
    return new Promise(resolve => BeaconsManager.getRangedRegions(resolve));
}
/**
...
function checkTransmissionSupported() {
    return new Promise((resolve) => {
        BeaconsManager.checkTransmissionSupported((status) => // TODO: Figure these two out
...
function startMonitoringForRegion(region) {
    ...
    BeaconsManager.startMonitoring(region.identifier, region.uuid, region.minor ? region.minor : -1, region.major ? region.major : -1, resolve, reject));
}
/**
...
function stopMonitoringForRegion(region) {
    return new Promise((resolve, reject) => BeaconsManager.stopMonitoring(region.identifier, region.uuid, region.minor ? region.minor : -1, // TODO: This will likely result in a bug when major/minor are 0
    region.major ? region.major : -1, resolve, reject));
}
/**
 ...
 * @returns {Promise<any>} promise resolves to void or error
 */
function startRangingBeaconsInRegion(region, beaconsUUID) {
    if (typeof region === 'object')
        return new Promise((resolve, reject) => BeaconsManager.startRanging(region.identifier, region.uuid, resolve, reject));
    else
        return new Promise((resolve, reject) => BeaconsManager.startRanging(region, beaconsUUID, resolve, reject));
}
/**
 ...
 */
function stopRangingBeaconsInRegion(region, beaconsUUID) {
    if (typeof region === 'object')
        return new Promise((resolve, reject) => BeaconsManager.stopRanging(region.identifier, region.uuid, resolve, reject));
    else
        return new Promise((resolve, reject) => BeaconsManager.stopRanging(region, beaconsUUID, resolve, reject));
}
export { 
// parsers constants
PARSER_IBEACON, PARSER_ESTIMOTE, PARSER_ALTBEACON, PARSER_EDDYSTONE_TLM, PARSER_EDDYSTONE_UID, PARSER_EDDYSTONE_URL, BeaconsEventEmitter, setHardwareEqualityEnforced, 
// iBeacons:
detectIBeacons, addIBeaconsDetection, removeIBeaconsDetection, 
// alt beacons:
detectAltBeacons, addAltBeaconsDetection, removeAltBeaconsDetection, 
// Estimotes beacon:
detectEstimotes, addEstimotesDetection, removeEstimotesDetection, 
// Eddystone UID beacons:
detectEddystoneUID, addEddystoneUIDDetection, removeEddystoneUIDDetection, 
// Eddystone TLM beacons:
detectEddystoneTLM, addEddystoneTLMDetection, removeEddystoneTLMDetection, 
// Eddystone URL beacons:
detectEddystoneURL, addEddystoneURLDetection, removeEddystoneURLDetection, 
// custom layout beacons (NOTE: create 'valid UUID' with websites like, for instance, this one: https://openuuid.net):
detectCustomBeaconLayout, addCustomBeaconLayoutDetection, removeCustomBeaconLayoutDetection, addParsersListToDetection, removeParsersListToDetection, setBackgroundScanPeriod, setBackgroundBetweenScanPeriod, setForegroundScanPeriod, setRssiFilter, checkTransmissionSupported, getRangedRegions, ARMA_RSSI_FILTER, RUNNING_AVG_RSSI_FILTER, getMonitoredRegions, 
// common with iOS:
